...
data_train_scaled = pd.read_csv(
    r'D:\python file\vinix\Tugas_Final\app\CSV\data_train_scaled.csv'
)

data_val_scaled = pd.read_csv(
    r'D:\python file\vinix\Tugas_Final\app\CSV\data_val_scaled.csv'
)

data_test_scaled = pd.read_csv(
    r'D:\python file\vinix\Tugas_Final\app\CSV\data_test_scaled.csv'
)
...
st.image(
    r'D:\python file\vinix\Tugas_Final\app\Stat\time_series_plot.png',
    use_container_width=True
)
